...
def extract_coordinates_from_plus_code(address: str):
    ...
    # Приблизительные координаты для основных Plus кодов
    plus_code_coords = {
        # Газалкент, Узбекистан (HQXX)
        'HQCQ+XCV': (40.522189, 72.800595),  # Точные координаты
        'HQCR+P7X': (40.520865, 72.814095),  # Точные координаты  
        'HQ9R+Q7H': (40.519531, 72.813784),  # Точные координаты
        'HQ9Q+P98': (40.518750, 72.813000),  # Точные координаты
        ...
        'HQ9Q+': (40.518, 72.813), # Базовые координаты для HQ9Q+
