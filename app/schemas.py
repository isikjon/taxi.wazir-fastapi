...
class OrderBase(BaseModel):
    ...
    origin_lat: Optional[float] = Field(None, description="Широта точки отправления")
    origin_lng: Optional[float] = Field(None, description="Долгота точки отправления")
    destination_lat: Optional[float] = Field(None, description="Широта точки назначения")
    destination_lng: Optional[float] = Field(None, description="Долгота точки назначения")
